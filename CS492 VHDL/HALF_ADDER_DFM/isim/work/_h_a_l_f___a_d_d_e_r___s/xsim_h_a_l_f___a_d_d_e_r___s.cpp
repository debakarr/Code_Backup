...
va_list vap)
{
    extern HSim__s6 * createworkM_h_a_l_f___a_d_d_e_r___s(const char*);
    HSim__s6 *blk = createworkM_h_a_l_f___a_d_d_e_r___s(label); 
    return blk;
}
...
public:
    ...
    HSimConfigDecl * topModuleInstantiate() {
        ...
        (*cfgvh).addVlogModule("work","HALF_ADDER_S", (HSimInstFactoryPtr)IF0);
        ...
        HSim__s5 * topvl = 0;
        extern HSim__s6 * createworkM_h_a_l_f___a_d_d_e_r___s(const char*);
        topvl = (HSim__s5*)createworkM_h_a_l_f___a_d_d_e_r___s("HALF_ADDER_S");
